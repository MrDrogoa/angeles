...
const base =
  "cursor-pointer bg-[#1B3EC1] hover:bg-none lg:hover:bg-[#5F38BB] text-[#FFFFFF] transition-colors duration-300 font-medium rounded-2xl px-4 py-2 text-sm lg:text-base xl:text-lg";

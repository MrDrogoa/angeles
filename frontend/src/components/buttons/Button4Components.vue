...
const base =
  "cursor-pointer bg-[#FF2600] hover:bg-none lg:hover:bg-[#FF5700] text-white transition-colors duration-300 font-semibold rounded-2xl px-4 py-2 text-sm lg:text-base xl:text-lg mode-btn";

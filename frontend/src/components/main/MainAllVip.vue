  ...
  <section>
    ...
    <div class="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-6">
      ...
      <div
        ...
        :class="card.class"
        class="w-[calc(30%-0.375rem)] lg:w-[calc(25%-1.125rem)] max-w-[180px] md:max-w-[260px] lg:max-w-[300px] relative border-2 border-[#FFD700] rounded-xl overflow-hidden cursor-pointer transition-all duration-300 hover:border-white hover:shadow-2xl hover:-translate-y-2"
      >
        <!-- Imagen con overlay -->

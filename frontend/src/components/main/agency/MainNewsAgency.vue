...
const categories = [
  ...
  {
    id: "fotos-nuevas",
    label: "Condominio departamento 1",
  ...
  {
    id: "promociones",
    label: "Condominio departamento 2",
...
<template>
  <section class="max-w-[1300px] mx-auto pt-8 md:pt-20 lg:pt-25 xl:pt-30 px-4">
